...
public class Shop {
    ...
    private List<UnitData> currentShop; // list of current champions available in the shop
    ...
    public void makePurchase(UnitData champion) { // get a champion unitdata and remove 1 from their bag size 
    // should be safe to remove, function can only get called for champions with

    }

    //public List<UnitData> generateShop(Player playerData) { // based off of the current level, generate 5 units to be displayed in the shop 
    //}
